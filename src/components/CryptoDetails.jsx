  ...
  return (
    <Col className='coin-detail-container'>
         ...
         <Select defaultValue="7d" className="select-timeperiod" placeholder="Select Timeperiod" onChange={(value) => setTimeperiod(value)}>
             ...
             <LineChart ch={ch} coinHistory={coinHistory} currentPrice={millify(cryptoDetails?.price)} coinName={data?.data?.coin.name} />
         <Col className='stats-container'>
             ...
             <Col className='other-stats-info'>
                 <Col className='coin-value-statistics-heading'>
                 <Title level={3} className="coin-details-heading">Other Statistic</Title>
                      <p>An overview showing the statistics of All cryptocurrencies  </p>
                 </Col>
